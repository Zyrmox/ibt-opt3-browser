<x-jet-form-section>
    <!--
        Invitations Form - Livewire Component
        Controller for this component: App/Http/Livewire/Organisms/InvitationsForm.php
    ...
    <x-slot name="description">
        Přehled všech odeslaných pozvánek k registraci.
    </x-slot>
